            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                    <li role="presentation">
                        <a href="#teacher_courses" aria-controls="teacher_courses" role="tab" data-toggle="tab">
                ...
                <div class="tab-content">
                    <div class="tab-pane" role="tabpanel" id="teacher_courses">
                        @includeIf('admin.users.relationships.teacherCourses', ['courses' => $user->teacherCourses])
                    </div>
                </div>
            </div>
