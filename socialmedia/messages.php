...
while ($row_msg = mysqli_fetch_array($run_msg)) {
        ...
        <div id="loaded_msg">
            ...
            echo"<div class='message' id='blue' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";} else if($user_from == $user_to_msg AND $user_to == $user_from_msg)
            {echo"<div class='message' id='green' data-toggle='tooltip' title='$msg_date'>$msg_body</div> <br><br><br>";} ?></p></div>
...
if (isset($_GET['u_id'])) {
   ...
   if ($u_id == "new") {
       echo'
       <form>
       <center><h3>Select someone to start coversation</h3></center>
...
if (isset($_POST['send_msg'])) {
    ...
    if($msg == ""){
        ...
        if (strlen($msg) > 250 ){
            echo "<h4 style='color:red; text-align:center;'>Message is too long! Use only 250 characters</h4>";
    }else {
...
if (isset($_GET['u_id'])) {
    ...
    $row = mysqli_fetch_array($run_user);
        ...
        $egister_date= $row['user_reg_date'];
...
if ($get_id == "new") {
    ...
    <li class='list-group-item' title='Status'><strong>$user_status</strong></li>
    <li class='list-group-item' title='Level'><strong>$user_level</strong></li>
    <li class='list-group-item' title='Department'><strong>$user_dept</strong></li>
