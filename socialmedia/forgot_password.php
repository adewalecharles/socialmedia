...
<div class="row">
    <div class="col-sm-12">
        <div class="well">
            <center><h1 style="color: white;"><strong>Laspo Connect</strong></h1></center>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="main-content">
            ...
            <div class="l_pass">
                <form action="" method="post">
                    ...
                    <a style="text-decoration: none;float: right;color: #187FAB;" data-toggle="tootltip" title="Signin" href="signin.php">Back to Signin?</a><br><br>
