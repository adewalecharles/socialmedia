...
<div>
<div>
  <img id='cover-img' class='image-rounded' src='cover/$user_cover' alt='cover'>
  </div>
  <form action='profile.php?u_id=$user_id' method='post' enctype='multipart/form-data'>
<ul class='navbar pull-left' style='position:absolute;top:10px;left:40px;'>
<li class='dropdown'>
...
<button id='button_profile' name='update' class='btn btn-info'> Update Profile</button>
  ...
  <?php 
   if (isset($_POST['submit'])) {
       ...
       if ($u_cover == '') {
           ...
           if ($run) {
            echo "<script>alert('your cover is updated succesfully!')</script>";
            echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
           }
       }
   }
  ...
  if (isset($_POST['update'])) {
    ...
    if ($u_image == '') {
        ...
        if ($run) {
         echo "<script>alert('your profile is updated succesfully!')</script>";
         echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
        }
    }
}
...
<div class="col-sm-2" style="background-color: #e6e6e6;text-align:center; left:0.8%;border-radius:5px;"> 
    <?php 
    echo "
    <center><h2><strong>About</stsrong></h2></center>
    ...
    <p><strong>Status:</strong> $user_status</p><br>
    <p><strong>Level:</strong> $user_level</p><br>
    <p><strong>Department:</strong> $user_dept</p><br>
...
while ($row_posts = mysqli_fetch_array($run_posts)) {
    ...
    if ($content == 'No' && strlen($upload_image) >= 1) {
        ...
        <div class='row'>
        <div class='col-sm-12'>
        <img id='post_img' src='imagepost/$upload_image' style='height:350px;'>
        </div>
        </div><br>
