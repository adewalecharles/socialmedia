<?php 
$con = mysqli_connect("localhost", "root", "blogger1", "socialmedia") or die ("connection was not established");

//function inserting a post 
...
function insertPost(){
    if (isset($_POST['sub'])) {
        ...
        if (strlen($content) > 250) {
          echo "<script>alert('You cannot post more 250 characters')</script>";
...
function get_posts(){
    ...
    while($row_posts = mysqli_fetch_array($run_posts)){
        ...
        $content = substr($row_posts['post_content'], 0,255);
        ...
        if ($content=="No" && strlen($upload_image) >= 1) {
           ...
           <div class='row'>
           <div class='col-sm-12'>
           <img id='posts' src='imagepost/$upload_image' style='height:350px;'>
           </div>
           </div><br>
...
function search_user(){
    ...
    while ($row_user = mysqli_fetch_array($run_user)) {
        ...
        <img src='users/$user_image' width='150px' height='150px' title='$username' style='float:left; margin:1px;'></a>
        </div><br><br>
        <div class='col-sm-6'>
